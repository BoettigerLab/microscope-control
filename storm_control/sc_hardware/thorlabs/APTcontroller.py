...
class APTcontroller():
    ...
    #
    #
    def __init__(self, xStageSN = '27003853', yStageSN = '27003868'): 
        ...
        self.unit_to_um = 1000.0 #  controller reports in mm    # <--- should become a parameter
        self.um_to_unit = 1.0/self.unit_to_um  # <--- should become a parameter
